...
def process_config():
        ...
        data_arg.add_argument('--data_dir', type=str, default='dataset/nyt/')
        ...
        data_arg.add_argument('--num_fold', type=int, default=1, help='the number of folds in Cross-Validation')  # e.g., 5 for asap
