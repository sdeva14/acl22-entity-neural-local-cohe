...
def process_config():
        ...
        data_arg.add_argument('--data_dir', type=str, default='dataset/gcdc/')
        ...
        data_arg.add_argument('--use_nounp', type=str2bool, default='True', help='Decide whether to generate new cv or reuse')  # disabled in this submission for reproduction
        # data_arg.add_argument('--use_nounp', type=str2bool, default='False', help='Decide whether to generate new cv or reuse')  # disabled in this submission for reproduction
        ...
        data_arg.add_argument('--num_fold', type=int, default=10, help='the number of folds in Cross-Validation')  # e.g., 5 for asap
        ...
        data_arg.add_argument('--use_lower', type=str2bool, default=True, help="whether to lowercase to text")  #
        data_arg.add_argument('--use_coref', type=str2bool, default=False, help="whether to use coreference resolution")  #

        data_arg.add_argument('--use_np_focus', type=str2bool, default=True, help="whether to use np focus")  #

        data_arg.add_argument('--use_np_center', type=str2bool, default=False, help="whether to use noun phrases for centering")  #
        data_arg.add_argument('--len_threshold_np', type=int, default=3, help="threshold for length of words consist NP")  #
        ...
        net_arg.add_argument('--max_grad_norm', type=float, default=1.0)  # param for torch.nn.utils.clip_grad_norm
        ...
        specific_arg.add_argument('--topk_fwr', type=int, default=5)  # used in cent_attn
        specific_arg.add_argument('--topk_back', type=int, default=1)  # used in cent_attn
        specific_arg.add_argument('--threshold_sim', type=float, default=0.95)  # used in cent_attn

        specific_arg.add_argument('--out_interpret', type=str2bool, default=False)  # used in cent_attn
        specific_arg.add_argument('--encode_type', type=str, default="sent")  # decide to encoding type for a text
