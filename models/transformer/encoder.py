...
from models.transformer.neural import MultiHeadedAttention, PositionwiseFeedForward
from models.transformer.rnn import LayerNormLSTM
...
class TransformerInterEncoder(nn.Module):
    def __init__(self, d_model, d_ff, heads, dropout, num_inter_layers=0):
        ...
        self.dropout = nn.Dropout(dropout)
        self.layer_emb = nn.LayerNorm(d_model, eps=1e-6)
        self.layer_norm = nn.LayerNorm(d_model, eps=1e-6)
    ...
    def forward(self, top_vecs, mask):
        ...
        # x = self.layer_emb(x)  # added later
        # x = self.dropout(x)  # added later
